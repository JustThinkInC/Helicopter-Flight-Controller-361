...
//Variables for main
static float kp = 1.5;//0.7;//1;
static float ki = 0.08;//0.08;//0.0009;
static float kd = 0.1;//0.1;//0.8;
static signed int prevError = 0;
static signed int I = 0;
static signed int prevT = 0;

//Variables for tail
static float kpTail = 0.5;//0.5;
static float kiTail = 0.0005;//0.0005;//0.0005;
static float kdTail = 0.1;//0.1;
...
uint32_t pidControlMain(uint32_t target, uint32_t current, uint32_t ticks) {
    ...
    control = P + (I + dI) + D;//+ (error_integrated * ki + dI) + error_derivative * kd;
